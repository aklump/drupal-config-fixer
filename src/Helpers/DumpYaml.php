...
class DumpYaml {
  ...
  /**
   * Encode $data the way Drupal writes exported config.
   *
  ...
  public function __invoke(array $data): string {
    return Yaml::dump($data, PHP_INT_MAX, 2, Yaml::DUMP_EXCEPTION_ON_INVALID_TYPE | Yaml::DUMP_MULTI_LINE_LITERAL_BLOCK);
  }
